...
export const PRE_DAY_NIGHT_MS = 500;
export const PRE_DAY_DAWN_MS = 500;
...
export const MINIMUM_BOTTLES_TO_REDEEM = 8;

export const BIN_COUNT = 10;
export const LOOSE_BOTTLE_COUNT = 8;
...
export const REWE_WAIT_MAX_MS = 6_000;
export const DONER_WAIT_MIN_MS = 2_000;
export const DONER_WAIT_MAX_MS = 4_000;
